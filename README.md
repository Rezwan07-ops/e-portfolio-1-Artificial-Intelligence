...
## Artefact 1: 
Inside Waymo’s Self-Driving Car // Day in Life of a Fully Autonomous Future!

<img width="1349" height="754" alt="SSSSSSSSS" src="https://github.com/user-attachments/assets/bdaf26ef-333c-4f69-ad95-37d1c4b98953" />



(https://www.youtube.com/watch?v=vaV7UWT9uZQ)

### Summary of the artefact
This video shows the point of view of a rider in a Waymo self-driving car. It explains how you can access the vehicle using the Waymo app. This video also shows there are multiple cameras and sensors surrounding the car which assists the vehicle to point out obstacles, other cars and pedestrians in real time. Throughout the whole ride, the vehicle detects the road signs and acts according to it. It feels like an impression that a real person is driving the car.

### Justification on why I chose the artefact
I chose the Waymo self-driving car video because it gives me a clear idea about a self-driving car and its characteristics. It relates to one of our workshop contents from week 2 where we discussed about AI driven car and how the cameras and sensors help AI to drive the car without any trouble. One of the facts that stood out to me is the driving felt like a real human was behind the wheel. This relates to what McCarthy said that behavior of AI will almost feel like as if a human did the same (McCarthy 1955, cited in Galea 2026). But, since i watched the ride instead of physically experiencing it, i realized that my whole conception about this technology is totally based on observation, not on physical experience. I would have trusted it more if i rode in one of the self driving cars. This made me realize that machine is not always perfect.
...
### Justification on why I chose the artefact
The reason why I chose this article is after watching the video, i raised a question about who will be responsible if AI makes a mistake and that's what happened as mentioned in the article. Even though the child was running in the street, I think Waymo should be held responsible since human drivers would have driven more carefully in the area. So, I think self-driving automated cars are not yet safer option than humans and it needs more technical development.
...
<img width="900" height="500" alt="IMG_1263 (1)" src="https://github.com/user-attachments/assets/0bce362f-bc7f-478f-9b9e-c9e0cb1cf717" />
...
In our workshop 2, we studied Artificial Intelligence and its history. We had an interesting discussion with the tutor, and we were asked few challenging and provoking questions which were really difficult to answer. One of the most important concepts we learnt was that the AI cannot overpower the human mind and intelligence.
